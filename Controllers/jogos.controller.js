    ...
    try{
        ...
        if(jogosCount > 0){
            ...
            const jogos = [
                ...
                {"nome": "Sonic", "foto": "mario.png", "sinopse": "O porco-espinho Sonic é teletransportado para a Terra. Após causar uma pane elétrica em parte dos Estados Unidos, ele precisa escapar do maligno cientista Dr. Robotnik."}
            ]
